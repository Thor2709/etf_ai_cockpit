...
- `IN_PROGRESS` final B00 feature-branch review, push/PR/CI/merge, post-merge control-base refresh, and checksum-approved GitHub sync apply/readback. These convergence actions remain required before B00 is closed.
