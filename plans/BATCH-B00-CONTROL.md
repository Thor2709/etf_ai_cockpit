...
- `IN_PROGRESS` clean locked-environment enforcing `--full` rerun, final B00 evidence review, and root integration workflow. Post-merge control-base refresh and checksum-approved GitHub sync apply/readback remain required before B00 is closed.
