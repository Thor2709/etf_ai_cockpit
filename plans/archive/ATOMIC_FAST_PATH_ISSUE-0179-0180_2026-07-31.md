# Archived ISSUE-0179/0180 fast-path procedure and evidence

This file preserves the complete pre-alignment active-goal record from PR #632 head `e30ffd6237c615cb9e68cdd362289fa2785a7a80`. It is historical evidence, not current operational instruction. Current mechanics are in `docs/product-completion/DELIVERY_WORKFLOW.md` and the current task is in `plans/ACTIVE_CODEX_GOAL.md`.
