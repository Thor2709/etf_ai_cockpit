...
This file preserves the complete pre-alignment `plans/BATCH-DOCS-SDD-20260727.md` record from PR #632 head `e30ffd6237c615cb9e68cdd362289fa2785a7a80`. It is historical evidence, not current operational instruction. Current mechanics are in `docs/product-completion/DELIVERY_WORKFLOW.md`.
