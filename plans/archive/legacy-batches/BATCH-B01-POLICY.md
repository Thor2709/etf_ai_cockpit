# Archived historical batch record

This file preserves the complete pre-alignment `plans/BATCH-B01-POLICY.md` record from PR #632 head `e30ffd6237c615cb9e68cdd362289fa2785a7a80`. It is historical evidence, not current operational instruction. Current mechanics are in `docs/product-completion/DELIVERY_WORKFLOW.md`.
...
- `VERIFIED` PR `#461` passed status-transition, supply-chain, Linux release and Windows release checks on exact head `00155675190542dad63aa1b2295d730336cb96e1` and merged as `4413de82baec0dcb00e9cc81e887200bf33a962a`. The fresh post-merge GitHub plan retained exact semantic checksum `d456208ac986550978ee4fa8f47cd8783e08e18cf18dd24c83e802343b0dc111`, applied only ISSUE-0008/#12 and ISSUE-0037/#85 Programme-status updates, verified readback and regenerated to zero actions.
- `IN_PROGRESS` the second schema-`1.2` convergence advances only ISSUE-0037 `in_progress -> implemented_initially` with verified ancestor `4413de82baec0dcb00e9cc81e887200bf33a962a`. Registry count remains 197, the fresh GitHub projection contains only ISSUE-0037/#85 Programme status, and no issue addition, removal, downgrade, dependency, policy or execution-authority change is authorised. Independent review passed with no findings; protected CI and the later checksum-reviewed one-action apply/readback remain.
- `VERIFIED` PR `#462` passed the status-transition and supply-chain checks on exact head, retained the exact deterministic 35-file evidence allowlist and had no reviews. Under the repository's evidence-only fast path, the checksum-approved one-action GitHub plan (`fadf4560c9f8dfa370c812052435b7bb0a21d6d102d2abe1be7f7c21d0d53e6b`) updated only ISSUE-0037/#85, verified readback regenerated to zero actions, and the PR merged as `be837a16d3687a5d46e66da7d2f220218c3ded54` without waiting for redundant platform gates.
- `IN_PROGRESS` the final schema-`1.2` convergence advances only ISSUE-0037 `implemented_initially -> integrated` with verified ancestor `be837a16d3687a5d46e66da7d2f220218c3ded54`. Registry count remains 197; the fresh GitHub projection contains exactly one ISSUE-0037/#85 Programme-status update with semantic SHA-256 `b19d524161a2753a27e864257e08faf7a0c003f482591a472136f96df2685080`; no issue addition, removal, downgrade, dependency, policy or execution-authority change is authorised.
- `VERIFIED` the independent Sol-medium review passed the complete final-convergence diff with no blocking or non-blocking findings. It confirmed one exact append-only control event, one ISSUE-0037 generated-record delta, 197 records, unchanged policy/dependencies/unrelated records, `execution_allowed=false`, exact schema-`1.2` hashes, deterministic generated documents, and the one-action safe-sync sidecar. The reviewer independently passed the 38 focused guard tests, registry/status/document validation, Ruff, compileall and `git diff --check`; only committed-head protected checks and checksum-approved apply/readback remain.
