...
def _snapshot():
    ...
    for index in range(8):
        ...
        rows.extend({"date": day.date(), "etf_id": identity, "adjusted_close": value, "volume": 10000.0} for day, value in zip(dates, values))
    ...
    holdings = pd.DataFrame([{"etf_id": "ETF0", "current_weight": 1.0, "market_value_eur": 1000.0, "as_of_date": str(as_of)}])
