...
|---|---|
| Updated | 2026-07-12 |
| Active phase | Wave 1 Governance Task 3 independently approved, merged through PR 173 and post-merge verified; Wave 1 Governance Task 4 is next |
| Active plan | `docs/superpowers/plans/2026-07-11-etf-ai-cockpit-governance-plan.md` |
| Git state | `main` is clean and matches `origin/main` at `5fde19639da9caa6cdb01eef852dc34698b53482`; Task 3 PR 173 is integrated and the GitHub issue mirror remains synchronised |
...
| 1 | governance | Tasks 1-3 independently approved and merged; Task 4 next | Task 3 severity-aware resolver, complete ordered gate evidence and release-path propagation | write the portfolio review report and Decision Journal RED suite |
...
3. Continue only the first unchecked task whose prerequisites are verified; Wave 0 Tasks 1-5 and Wave 1 Governance Tasks 1-3 are merged and post-merge verified. Start Wave 1 Governance Task 4 with a fresh implementer and independent reviewer; do not close `UPDATEV2-0029`, `ISSUE-0013`, `ISSUE-0014`, `ISSUE-0045`, `ISSUE-0040` or the governance issues until their complete UI/package/browser and authority gates pass.
