...
|---|---|
| Updated | 2026-07-12 |
| Active phase | Wave 0 Task 4 independently approved, corrected after post-merge verification, merged and verified; Wave 0 Task 5 is next |
| Active plan | `docs/superpowers/plans/2026-07-11-etf-ai-cockpit-foundation-operations-boundary-plan.md` |
| Git state | `main` is clean and matches `origin/main` at merge commit `5b732e4e99d3139c3f5e370781c454ecb9718dad`; Task 4 PRs 2 and 3 are integrated |
...
|---:|---|---|---|---|
| 0 | foundation, operations and boundary | Tasks 1-4 independently approved, merged and post-merge verified; Task 5 next | Task 4: 54 scope/release tests, 75 release/operations tests, fresh independent post-merge review, deterministic 358-file static scan with zero violations, false-authority invariants, source smoke; PR 2 `0f2b2cb`, PR 3 `5b732e4` | Start Task 5 evidence-automation RED suite; `ISSUE-0040` and later tracker issues remain open |
...
3. Continue only the first unchecked task whose prerequisites are verified; Tasks 1-4 are merged and post-merge verified. Start Task 5 with a fresh implementer and independent reviewer; do not close `ISSUE-0040` until its later UI/package/browser gates pass.
...
Task 5 is the next dependency-valid task.
