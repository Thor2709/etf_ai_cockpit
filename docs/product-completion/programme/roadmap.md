...
|---|---|---:|---|---|
| `phase-01-governance-scope` | `ISSUE-0070–ISSUE-0079` - Governance, scope and completion contract | 43 | closed=2, implemented_initially=7, in_progress=4, integrated=10, planned=18, research_only=2 | data-platform, platform-and-operations, programme-governance, reproducibility, scoring-and-evidence, security-and-release |
