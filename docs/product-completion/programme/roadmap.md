...
| `phase-02-data-policy-identity` | `ISSUE-0080–ISSUE-0090` - Local-first data policy, identity and data platform | 28 | closed=2, implemented_initially=6, in_progress=2, integrated=2, planned=16 | data-and-evidence, data-platform |
...
| `phase-09-quality-release-security` | `ISSUE-0141–ISSUE-0146` - Quality, release, security and resilience | 6 | integrated=2, planned=4 | programme-governance, quality-and-release, security-and-release |
