...
The canonical blocking graph is available as `docs/product-completion/reconciliation/2026-07-21-a0e31fc/canonical-dag.json`. Cyclic raw candidates were converted to related references with reasons rather than silently dropped.
