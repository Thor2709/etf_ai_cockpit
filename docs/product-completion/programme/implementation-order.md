...
9. **phase-09-quality-release-security** - Quality, release, security and resilience (ISSUE-0141–ISSUE-0146, ISSUE-0169, ISSUE-0176–ISSUE-0178, ISSUE-0180; 11 records).
...
The canonical blocking graph is available as `docs/product-completion/reconciliation/2026-07-21-4119de7/canonical-dag.json`. Cyclic raw candidates were converted to related references with reasons rather than silently dropped.
