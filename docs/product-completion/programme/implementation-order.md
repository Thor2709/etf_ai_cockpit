...
The canonical blocking graph is available as `docs/product-completion/reconciliation/2026-07-21-d69113a/canonical-dag.json`. Cyclic raw candidates were converted to related references with reasons rather than silently dropped.
