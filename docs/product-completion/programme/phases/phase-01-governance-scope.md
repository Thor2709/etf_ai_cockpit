...
Phase `phase-01-governance-scope` covers `ISSUE-0070–ISSUE-0079`. The issue registry remains the canonical source for titles, priorities, state and acceptance criteria; this document records phase-specific implementation guidance.
...
| `ISSUE-0021` | `P1` | `planned` | `programme-governance` | - | `ISSUE-0110`, `ISSUE-0116`, `ISSUE-0130` |
| `ISSUE-0024` | `P1/P2` | `planned` | `programme-governance` | - | `ISSUE-0073`, `ISSUE-0084`, `ISSUE-0085`, `ISSUE-0130` |
| `ISSUE-0026` | `P1/P2` | `planned` | `programme-governance` | - | `ISSUE-0073`, `ISSUE-0088`, `ISSUE-0115` |
| `ISSUE-0027` | `P1` | `planned` | `programme-governance` | - | `ISSUE-0117`, `ISSUE-0124`, `ISSUE-0139` |
...
| `ISSUE-0036` | `P1/P2` | `implemented_initially` | `programme-governance` | - | `ISSUE-0081`, `ISSUE-0086`, `ISSUE-0127`, `ISSUE-0146` |
| `ISSUE-0039` | `P1/P2` | `in_progress` | `platform-and-operations` | - | `ISSUE-0077`, `ISSUE-0078`, `ISSUE-0151` |
| `ISSUE-0040` | `P1` | `in_progress` | `platform-and-operations` | - | `ISSUE-0077`, `ISSUE-0089`, `ISSUE-0135`, `ISSUE-0146` |
| `ISSUE-0044` | `P1/P2` | `implemented_initially` | `platform-and-operations` | - | `ISSUE-0145`, `ISSUE-0146` |
| `ISSUE-0047` | `P1` | `implemented_initially` | `programme-governance` | - | `ISSUE-0074`, `ISSUE-0098`, `ISSUE-0138` |
| `ISSUE-0049` | `P1` | `planned` | `programme-governance` | - | `ISSUE-0111`, `ISSUE-0115`, `ISSUE-0128` |
| `ISSUE-0050` | `P1` | `planned` | `programme-governance` | - | `ISSUE-0085`, `ISSUE-0125`, `ISSUE-0128`, `ISSUE-0134` |
...
| `ISSUE-0070` | `P0` | `ready` | `programme-governance` | `ISSUE-0008`, `ISSUE-0032`, `ISSUE-0060`, `ISSUE-0066` | - |
| `ISSUE-0071` | `P0` | `planned` | `programme-governance` | `ISSUE-0070` | - |
| `ISSUE-0072` | `P0` | `planned` | `data-platform` | `ISSUE-0038`, `ISSUE-0071` | - |
| `ISSUE-0073` | `P0` | `planned` | `data-platform` | `ISSUE-0072` | - |
| `ISSUE-0074` | `P0` | `planned` | `scoring-and-evidence` | `ISSUE-0071`, `ISSUE-0073` | - |
| `ISSUE-0075` | `P0` | `planned` | `reproducibility` | `ISSUE-0072`, `ISSUE-0074` | - |
| `ISSUE-0076` | `P0/P1` | `planned` | `platform-and-operations` | `ISSUE-0070`, `ISSUE-0071` | - |
| `ISSUE-0077` | `P0` | `planned` | `platform-and-operations` | `ISSUE-0072`, `ISSUE-0075` | - |
| `ISSUE-0078` | `P0/P1` | `planned` | `platform-and-operations` | `ISSUE-0077` | - |
| `ISSUE-0079` | `P0` | `planned` | `security-and-release` | `ISSUE-0145`, `ISSUE-0149` | - |
| `UPDATEV2-0012` | `P0` | `implemented_initially` | `programme-governance` | - | `ISSUE-0073`, `ISSUE-0081`, `ISSUE-0091` |
| `UPDATEV2-0014` | `P1` | `planned` | `programme-governance` | - | `ISSUE-0076`, `ISSUE-0087` |
