...
Phase `phase-08-frontend-api` covers `ISSUE-0136–ISSUE-0140`. The issue registry remains the canonical source for titles, priorities, state and acceptance criteria; this document records phase-specific implementation guidance.
...
| `ISSUE-0043` | `P2` | `planned` | `frontend-and-api` | - | `ISSUE-0148`, `ISSUE-0149` |
| `ISSUE-0045` | `P1` | `in_progress` | `frontend-and-api` | - | `ISSUE-0136`, `ISSUE-0143` |
| `ISSUE-0136` | `P0` | `planned` | `frontend-and-api` | `ISSUE-0071` | - |
| `ISSUE-0137` | `P0/P1` | `planned` | `frontend-and-api` | `ISSUE-0136` | - |
