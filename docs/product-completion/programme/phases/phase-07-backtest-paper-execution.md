...
Phase `phase-07-backtest-paper-execution` covers `ISSUE-0125–ISSUE-0135`. The issue registry remains the canonical source for titles, priorities, state and acceptance criteria; this document records phase-specific implementation guidance.
...
|---|---|---|---|---|---|
| `ISSUE-0031` | `P1` | `planned` | `trading-safety` | - | `ISSUE-0125`, `ISSUE-0127`, `ISSUE-0130` |
| `ISSUE-0032` | `P2` | `planned` | `trading-safety` | - | `ISSUE-0070`, `ISSUE-0131`, `ISSUE-0135` |
| `ISSUE-0057` | `P1` | `planned` | `trading-safety` | - | `ISSUE-0075`, `ISSUE-0129`, `ISSUE-0147` |
| `ISSUE-0066` | `P2` | `planned` | `trading-safety` | - | `ISSUE-0070`, `ISSUE-0127`, `ISSUE-0131`, `ISSUE-0135` |
...
| `ISSUE-0127` | `P0` | `planned` | `trading-safety` | `ISSUE-0072`, `ISSUE-0084` | - |
| `ISSUE-0128` | `P0/P1` | `planned` | `trading-safety` | `ISSUE-0064` | `ISSUE-0106` |
| `ISSUE-0129` | `P0` | `planned` | `backtest-and-paper` | `ISSUE-0031`, `ISSUE-0057` | - |
| `ISSUE-0130` | `P0` | `planned` | `trading-safety` | `ISSUE-0070`, `ISSUE-0114` | - |
| `ISSUE-0131` | `P0/P1` | `planned` | `trading-safety` | `ISSUE-0066`, `ISSUE-0127` | - |
| `ISSUE-0132` | `P0` | `planned` | `trading-safety` | `ISSUE-0131` | - |
