...
|---|---|---|---|---|---|
| `ISSUE-0091` | `P0` | `planned` | `stock-research` | `ISSUE-0073`, `UPDATEV2-0012` | - |
| `ISSUE-0092` | `P0/P1` | `planned` | `stock-research` | `ISSUE-0074`, `ISSUE-0091` | - |
| `ISSUE-0093` | `P0/P1` | `planned` | `stock-research` | `ISSUE-0091` | - |
| `ISSUE-0094` | `P0/P1` | `planned` | `stock-research` | `ISSUE-0084`, `ISSUE-0091` | - |
| `ISSUE-0095` | `P1` | `planned` | `stock-research` | `ISSUE-0091` | - |
| `ISSUE-0096` | `P0/P1` | `planned` | `stock-research` | `ISSUE-0088`, `ISSUE-0091` | - |
| `ISSUE-0097` | `P1` | `planned` | `stock-research` | `ISSUE-0091`, `ISSUE-0092` | - |
| `ISSUE-0098` | `P0` | `planned` | `stock-research` | `ISSUE-0074`, `ISSUE-0083` | - |
