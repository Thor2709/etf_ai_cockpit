...
- The registry's blocking graph is acyclic; dependency conversions are recorded in `docs/product-completion/reconciliation/2026-07-21-379bb8a/dependency-reconciliation.csv`.
...
| `ISSUE-0154` | `P0` | `integrated` | `returns-and-risk` | `ISSUE-0085`, `ISSUE-0088`, `ISSUE-0153` | - | `ISSUE-0156`, `ISSUE-0157`, `ISSUE-0158` | - |
| `ISSUE-0156` | `P0/P1` | `implemented_initially` | `returns-and-risk` | `ISSUE-0091`, `ISSUE-0111`, `ISSUE-0154`, `ISSUE-0155` | - | `ISSUE-0157`, `ISSUE-0158` | - |
