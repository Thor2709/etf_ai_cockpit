...
- The registry's blocking graph is acyclic; dependency conversions are recorded in `docs/product-completion/reconciliation/2026-07-21-b906b40/dependency-reconciliation.csv`.
...
| `ISSUE-0156` | `P0/P1` | `integrated` | `returns-and-risk` | `ISSUE-0091`, `ISSUE-0111`, `ISSUE-0154`, `ISSUE-0155` | - | `ISSUE-0157`, `ISSUE-0158` | - |
