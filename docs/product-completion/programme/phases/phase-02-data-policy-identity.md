...
| `ISSUE-0038` | `P2` | `planned` | `data-and-evidence` | - | `ISSUE-0072`, `ISSUE-0073`, `ISSUE-0090` |
...
| `ISSUE-0080` | `P0` | `planned` | `data-platform` | `ISSUE-0070`, `ISSUE-0076` | - |
| `ISSUE-0081` | `P0` | `planned` | `data-platform` | `ISSUE-0072`, `ISSUE-0077`, `ISSUE-0080` | - |
| `ISSUE-0082` | `P0` | `planned` | `data-platform` | `ISSUE-0073`, `UPDATEV2-0011` | - |
| `ISSUE-0083` | `P0/P1` | `planned` | `data-platform` | `ISSUE-0082` | - |
| `ISSUE-0084` | `P0` | `planned` | `data-platform` | `ISSUE-0073`, `ISSUE-0082` | - |
...
| `ISSUE-0088` | `P0/P1` | `planned` | `data-platform` | `ISSUE-0073`, `ISSUE-0080`, `ISSUE-0081` | - |
| `ISSUE-0089` | `P0` | `planned` | `data-platform` | `ISSUE-0073`, `UPDATEV2-0021` | - |
| `ISSUE-0090` | `P0/P1` | `planned` | `data-platform` | `ISSUE-0072`, `ISSUE-0075` | - |
| `UPDATEV2-0011` | `P0` | `in_progress` | `data-and-evidence` | - | `ISSUE-0082`, `ISSUE-0083` |
| `UPDATEV2-0015` | `P0` | `closed` | `data-and-evidence` | - | `ISSUE-0090`, `ISSUE-0103`, `ISSUE-0104` |
| `UPDATEV2-0016` | `P0` | `closed` | `data-and-evidence` | - | `ISSUE-0082`, `ISSUE-0105` |
| `UPDATEV2-0018` | `P1` | `planned` | `data-and-evidence` | - | `ISSUE-0104`, `UPDATEV2-0015` |
| `UPDATEV2-0021` | `P0` | `in_progress` | `data-and-evidence` | - | `ISSUE-0073`, `ISSUE-0089`, `ISSUE-0090` |
