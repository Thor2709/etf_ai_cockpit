...
| `ISSUE-0022` | `P1` | `implemented_initially` | `data-and-evidence` | - | - | - | `ISSUE-0082`, `ISSUE-0105`, `UPDATEV2-0016` |
...
| `ISSUE-0088` | `P0/P1` | `implemented_initially` | `data-platform` | `ISSUE-0073`, `ISSUE-0080`, `ISSUE-0081` | - | `ISSUE-0096`, `ISSUE-0107` | - |
