...
- The registry's blocking graph is acyclic; dependency conversions are recorded in `docs/product-completion/reconciliation/2026-07-21-41d2d6b/dependency-reconciliation.csv`.
...
| `ISSUE-0086` | `P0` | `implemented_initially` | `data-platform` | `ISSUE-0036`, `ISSUE-0082` | - | - | - |
