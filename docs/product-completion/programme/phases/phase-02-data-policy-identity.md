...
- The registry's blocking graph is acyclic; dependency conversions are recorded in `docs/product-completion/reconciliation/2026-07-21-d69113a/dependency-reconciliation.csv`.
...
| `ISSUE-0089` | `P0` | `in_progress` | `data-platform` | `ISSUE-0073`, `UPDATEV2-0021` | - | `ISSUE-0173` | - |
