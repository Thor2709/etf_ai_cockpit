...
- The registry's blocking graph is acyclic; dependency conversions are recorded in `docs/product-completion/reconciliation/2026-07-21-a71e747/dependency-reconciliation.csv`.
...
| `ISSUE-0084` | `P0` | `in_progress` | `data-platform` | `ISSUE-0073`, `ISSUE-0082` | - | `ISSUE-0094`, `ISSUE-0103`, `ISSUE-0127`, `ISSUE-0159`, `ISSUE-0163`, `ISSUE-0173` | - |
