...
- Reconciliation baseline: `67f8e98a2195499d4ca1150bca308b9931ecd32f` (`origin/main`).
...
- The current router exposes `27` registered routes. This is recorded as source evidence because the supplied plan's earlier route estimate was lower; no routes were removed in this documentation task.
