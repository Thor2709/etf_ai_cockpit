...
upstreams, lineage cycles and schema incompatibility fail closed, stale state
remains explicit, unknown or ambiguous references are rejected, and every
projection keeps `execution_allowed=false`.
