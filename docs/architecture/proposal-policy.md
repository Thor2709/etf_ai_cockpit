...
Each decision records a deterministic input checksum, policy checksum, gate
table, rationale, quantity delta, `as_of`, expiry and the alternatives
...
evidence under `data/operations/proposals/`; it is not an order ledger or paper
broker.
