...
Records use: Title, Status, Date, Context, Decision, Consequences, Alternatives,
and Evidence and links. Status is one of `accepted`, `proposed`, `superseded`
or `deprecated`.

| Record | Status | Subject |
|---|---|---|
| [ADR-0002](ADR-0002-layered-boundaries.md) | accepted | Layered dependency boundaries |
| [ADR-0003](ADR-0003-point-in-time-evidence.md) | accepted | Point-in-time evidence and source conflicts |
