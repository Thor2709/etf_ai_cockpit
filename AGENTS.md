...
clean pre/post state and working read/search tools. The editor is enabled only
through the proven staged-promotion route. Its adapter gives AGY only a fresh
